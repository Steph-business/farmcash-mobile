...
/// Catalogue des méthodes affichées au producteur (numéro OM 07 09 88 30 51).
final _methodes = catalogueMethodes(numeroOmLie: '07 09 88 30 51');

const _kQuickAmounts = [5000, 10000, 25000, 50000];

/// Page Recharger Wallet producteur — montant + méthode de paiement + CTA
/// sticky.
///
/// Lecture du solde via `financeService.getWallet()` (mock visuel à 245 800
/// F pour rester fidèle à la maquette). Au tap "Recharger", appelle
/// `financeService.topupWallet(...)` avec une clé d'idempotence
/// pseudo-aléatoire.
