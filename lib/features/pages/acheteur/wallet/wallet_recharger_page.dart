...
class _MethodSpec {
  ...
  final Color logoBg;
  final Color logoFg;
  final bool linked; // simule "compte lié"
  final String apiId;
...
/// Page Recharger Wallet acheteur — montant + méthode de paiement + CTA sticky.
///
...
class _WalletRechargerAcheteurPageState
  ...
  int _selectedQuick = 50000; // actif par défaut conforme à la maquette
...
class _BalanceCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Mock fidèle à la maquette HTML (245 800 F acheteur).
